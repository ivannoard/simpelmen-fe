...
const Dashboard = () => {
  const [data, setData] = useState([
    ...
    {
      id: 2,
      nomorPesanan: '003/BIKDK/1/VII/2022',
      tanggalPesanan: '12 September 2022',
      namaIKM: 'Ikha cathering',
      status: 1,
    },
    {
      id: 3,
      nomorPesanan: '007/BIKDK/2/VII/2022',
      tanggalPesanan: '12 September 2022',
      namaIKM: 'Ikha cathering',
      status: 3,
    },
    {
      id: 4,
      nomorPesanan: '001/BIKDK/3/VII/2022',
      tanggalPesanan: '12 September 2022',
      namaIKM: 'Ikha cathering',
      status: 3,
    },
    {
      id: 5,
      nomorPesanan: '012/BIKDK/4/VII/2022',
      tanggalPesanan: '12 September 2022',
      namaIKM: 'Ikha cathering',
      status: 2,
    },
                  ...
                  >
                    ...
                    <td className="text-center p-3">
                      <div className="flex items-center gap-4 justify-center">
                        ...
                        <button
                          onClick={() => resiModalHandling(item.nomorPesanan)}
