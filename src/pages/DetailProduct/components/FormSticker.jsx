    ...
    const finalPostProduct =
      fields.order_design === 'swadesign'
        ? {
            ...
            order_bentuk: fields?.order_bentuk,
    ...
    if (user) {
      if (valids) {
        ...
        navigate('/pesan-sekarang', {
          state: { data: data, formType: formType, formData: finalPostProduct },
        });
      } else {
        setAlertFail(true);
        setIsLoading(false);
      ...
      <div className="relative">
        ...
        <select
          ...
          className={`input-field-select-xs ${
            fields.order_bentuk && !validFields.order_bentuk && 'field-error'
          }`}
          aria-invalid={validFields.order_bentuk ? 'false' : 'true'}
        ...
        {fields.order_bentuk && !validFields.order_bentuk && (
          <ErrorMessage
